...
<xsl:stylesheet
    ...
    xmlns:sct="urn:iso:std:iso:20022:tech:xsd:pain.001.003.03"
                ...
                <xsl:for-each select="sct:CstmrCdtTrfInitn/sct:PmtInf">
                    <sdd:PmtInf>
                        ...
                        <sdd:PmtTpInf>
                            ...
                            <sdd:SeqTp>
                                <xsl:choose>
                                    <xsl:when test="sct:SeqTp">
                                        <xsl:value-of select="sct:SeqTp" />
                                    </xsl:when>
                        ...
                        <sdd:Cdtr>
                            <sdd:Nm>
                                <xsl:value-of select="sct:Dbtr/sct:Nm | sct:CdtTrfTxInf[1]/sct:Dbtr/sct:Nm" />
                            </sdd:Nm>
                                ...
                                <sdd:Id>
                                    <xsl:if test="sct:Dbtr/sct:Id/sct:OrgId/sct:Othr/sct:Id">
                                        <sdd:OrgId>
                                            <sdd:Othr>
                                                <sdd:Id>
                                                    <xsl:value-of select="sct:Dbtr/sct:Id/sct:OrgId/sct:Othr/sct:Id | sct:CdtTrfTxInf[1]/sct:Dbtr/sct:Id/sct:OrgId/sct:Othr/sct:Id" />
                                                </sdd:Id>
                                            </sdd:Othr>
                                        </sdd:OrgId>
                                    </xsl:if>
                            ...
                            <xsl:if test="sct:Dbtr/sct:PstlAdr/sct:Ctry or sct:CdtTrfTxInf[1]/sct:Dbtr/sct:PstlAdr/sct:Ctry">
                                <sdd:CtryOfRes>
                                    <xsl:value-of select="sct:Dbtr/sct:PstlAdr/sct:Ctry | sct:CdtTrfTxInf[1]/sct:Dbtr/sct:PstlAdr/sct:Ctry" />
                                </sdd:CtryOfRes>
                            </xsl:if>
                        </sdd:Cdtr>
                        <sdd:CdtrAcct>
                            <sdd:Id>
                                <sdd:IBAN>
                                    <xsl:value-of select="sct:DbtrAcct/sct:Id/sct:IBAN | sct:CdtTrfTxInf[1]/sct:DbtrAcct/sct:Id/sct:IBAN" />
                                </sdd:IBAN>
                            </sdd:Id>
                        </sdd:CdtrAcct>
                                        ...
                                        <sdd:MndtId>
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="sct:PmtId/sct:EndToEndId">
                                                    <xsl:value-of select="concat('MNDT-', sct:PmtId/sct:EndToEndId)" />
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:value-of select="concat('MNDT-', position())" />
                                                </xsl:otherwise>
                                            </xsl:choose>
                                        </sdd:MndtId>
                                    </sdd:MndtRltdInf>
    ...
    <xsl:template name="mapGrpHdr">
        ...
        <sdd:GrpHdr>
            ...
            <sdd:NbOfTxs>
                <xsl:value-of select="count(/sct:Document/sct:CstmrCdtTrfInitn/sct:PmtInf/sct:CdtTrfTxInf)" />
            </sdd:NbOfTxs>
